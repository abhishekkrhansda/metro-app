...
Please don't get confused, this is NOT an ANDROID Application ! it will give the shortest distance to reach any destination from starting Point.
...
Main.cpp cointains all the major code.
